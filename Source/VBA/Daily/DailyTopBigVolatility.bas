Attribute VB_Name = "DailyTopBigVolatility"
Function GetTopBigVolatilitySheets() As Variant
    Dim ws As Worksheet
    ...
    For Each ws In ThisWorkbook.Sheets
        If Not ShouldSkipSheet(ws.Name) Then
            If IsNumeric(ws.Range("V3").Value) Then
                For i = 1 To 5
                    If ws.Range("V3").Value > values(i) Then
    ...
    GetTopBigVolatilitySheets = sheetNames
End Function
