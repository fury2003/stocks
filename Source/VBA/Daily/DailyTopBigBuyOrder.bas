Attribute VB_Name = "DailyTopBigBuyOrder"
Function GetTopBigBuyOrderSheets() As Variant
    Dim ws As Worksheet
    ...
    For Each ws In ThisWorkbook.Sheets
        If Not ShouldSkipSheet(ws.Name) Then
            If IsNumeric(ws.Range("N3").Value) Then
                For i = 1 To 5
                    If ws.Range("N3").Value > values(i) Then
    ...
    GetTopBigBuyOrderSheets = sheetNames
End Function
