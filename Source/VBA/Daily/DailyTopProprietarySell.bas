Attribute VB_Name = "DailyTopProprietarySell"
Function GetTopProprietarySellSheets() As Variant
    Dim ws As Worksheet
    ...
    For Each ws In ThisWorkbook.Sheets
        If Not ShouldSkipSheet(ws.Name) Then
            If IsNumeric(ws.Range("J3").Value) Then
                For i = 1 To 5
                    If ws.Range("J3").Value < values(i) Then
    ...
    GetTopProprietarySellSheets = sheetNames
End Function
