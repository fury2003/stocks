Attribute VB_Name = "MonthlyTopForeignSell"
Function GetMonthlyTopForeignSellSheets() As Variant
    Dim ws As Worksheet
    ...
    For Each ws In ThisWorkbook.Sheets
        If Not ShouldSkipSheet(ws.Name) Then
            ...
            total = WorksheetFunction.Sum(ws.Range("E3:E25"))
    ...
    GetMonthlyTopForeignSellSheets = sheetNames
End Function
