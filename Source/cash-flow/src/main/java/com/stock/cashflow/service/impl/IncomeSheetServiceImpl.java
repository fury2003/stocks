    ...
    public void crawlData(String ticker, String period, String size) {
        ...
        if(!Objects.isNull(data)){
            ...
            items.forEach(item ->{
                ...
                entity.setNetRevenue(item.getIs4() / 1000000);
                entity.setGrossProfit(item.getIs2() / 1000000);
                entity.setCogs(item.getIs8() / 1000000);
                entity.setFinanceCharge(item.getIs38() / 1000000);
                entity.setInterestCost(item.getIs51() / 1000000);
                entity.setSellingExpenses(item.getIs52() / 1000000);
                entity.setOperatingExpenses(item.getIs39() / 1000000);
                entity.setFinancialActivitiesIncome(item.getIs37() / 1000000);
                entity.setOtherIncome(item.getIs43() / 1000000);
