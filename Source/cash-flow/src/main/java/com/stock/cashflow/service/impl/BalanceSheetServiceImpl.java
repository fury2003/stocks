    ...
    public void crawlData(String ticker, String period, String size) {
        ...
        if(!Objects.isNull(data)){
            ...
            items.forEach(item ->{
                ...
                entity.setShortTermAssets(item.getBs2() == null ? 0 : item.getBs2() / 1000000);
                entity.setLongTermAssets(item.getBs3() == null ? 0 : item.getBs3() / 1000000);
                entity.setLiabilities(item.getBs6() / 1000000);
                entity.setCurrentLiabilities(item.getBs8() == null ? 0 : item.getBs8() / 1000000);
                entity.setLongTermLiabilities(item.getBs9() == null ? 0 : item.getBs9() / 1000000);
                entity.setCashAndCashEquivalents(item.getBs13() / 1000000);
                entity.setShortTermInvestments(item.getBs16() / 1000000);
                entity.setAccountsReceivable(item.getBs20() == null ? 0 : item.getBs20() / 1000000);
                entity.setInventory(item.getBs29() == null ? 0 : item.getBs29() / 1000000);
