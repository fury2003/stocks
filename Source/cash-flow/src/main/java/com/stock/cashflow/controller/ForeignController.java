...
public class ForeignController {
    ...
    public String getDerivativesForeignData(@PathVariable String symbol, @RequestParam String startDate, @RequestParam String endDate) {
        ...
        return "Ket thuc cap nhat du lieu giao dich cua nuoc ngoai cho ma " + symbol + " tu ngay " + startDate + " den ngay " + endDate;
    }

    @GetMapping("all/historical-quotes")
    public String getDerivativesForeignData(@RequestParam String startDate, @RequestParam String endDate) {
        ...
        return "Ket thuc cap nhat du lieu giao dich cua nuoc ngoai cho tat ca ma chung khoan tu ngay " + startDate + " den ngay " + endDate;
    }
